...
for ( var i = 0; i < array_length(sorted_list); i++ )
{
	...
	write_text(_title_x+1, _title_y+1, c_black, _name, global.fnt_spr_chunky);
	write_text(_title_x, _title_y, c_lime, _name, global.fnt_spr_chunky); 

	write_text(_col_score_x+1, _title_y+1, c_black, _score, global.fnt_spr_chunky);
	write_text(_col_score_x, _title_y, c_lime, _score, global.fnt_spr_chunky);
